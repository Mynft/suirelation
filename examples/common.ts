...
export async function publish(packagePath: string, signer: RawSigner): Promise<SuiTransactionBlockResponse> {
...
export async function sendTx(tx: TransactionBlock, signer: RawSigner): Promise<SuiTransactionBlockResponse> {
